...
Agent Mesh combines **AXL** (a P2P network node) with **multiple AI agents** that can discover peers, send/receive messages, and autonomously make payments using the x402 protocol.
...
```bash
git clone https://github.com/Isaac-Kingsley007/Agent-Mesh.git
cd Agent-Mesh
```

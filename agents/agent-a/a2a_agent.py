...
# ---------------------------------------------------------------------------
_REQUIRED = {
    "AGENT_A_WALLET_ADDRESS": "Agent D's EVM address (receives payments)",
    "AGENT_A_EVM_PRIVATE_KEY": "Agent D's private key (makes outgoing payments)",
...
WALLET_ADDRESS   = os.environ["AGENT_A_WALLET_ADDRESS"]
PRIVATE_KEY      = os.environ["AGENT_A_EVM_PRIVATE_KEY"]
GEMINI_API_KEY   = os.environ["GEMINI_API_KEY"]
AXL_API          = os.environ.get("AGENT_A_AXL_API", "http://127.0.0.1:9012")
A2A_PORT         = int(os.environ.get("AGENT_A_A2A_PORT", "9014"))

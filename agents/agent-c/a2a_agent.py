...
# ---------------------------------------------------------------------------
_REQUIRED = {
    "AGENT_C_WALLET_ADDRESS": "Agent C's EVM address (receives payments)",
    "AGENT_C_EVM_PRIVATE_KEY": "Agent C's private key (makes outgoing payments)",
...
WALLET_ADDRESS   = os.environ["AGENT_C_WALLET_ADDRESS"]
PRIVATE_KEY      = os.environ["AGENT_C_EVM_PRIVATE_KEY"]
GEMINI_API_KEY   = os.environ["GEMINI_API_KEY"]
AXL_API          = os.environ.get("AGENT_C_AXL_API", "http://127.0.0.1:9022")
A2A_PORT         = int(os.environ.get("AGENT_C_A2A_PORT", "9024"))
...
# ---------------------------------------------------------------------------
# This is what Agent D uses to pay OTHER agents (MCP or A2A) when it
...
logger.info(f"Agent D buyer wallet (pay): {_account.address}")

...
logger = logging.getLogger("agent-d")

# ---------------------------------------------------------------------------
# Validate required env vars
# ---------------------------------------------------------------------------
_REQUIRED = {
    "AGENT_D_WALLET_ADDRESS": "Agent D's EVM address (receives payments)",
    "AGENT_D_EVM_PRIVATE_KEY": "Agent D's private key (makes outgoing payments)",
...
WALLET_ADDRESS   = os.environ["AGENT_D_WALLET_ADDRESS"]
PRIVATE_KEY      = os.environ["AGENT_D_EVM_PRIVATE_KEY"]
GEMINI_API_KEY   = os.environ["GEMINI_API_KEY"]
AXL_API          = os.environ.get("AGENT_D_AXL_API", "http://127.0.0.1:9032")
